...
def ocrPublication(pathToMemex, citationKey, language):
    ...
    publPath = functionsrom.generatePublPath(pathToMemex, citationKey)
...
def processAllRecords(bibData):
    ...
    for key in keys:
        ...
        # 1. create folders, copy files
        functionsrom.processBibRecord(memexPath, bibRecord)
...
bibData = functionsrom.loadBib(settings["bib_all"])
processAllRecords(bibData)
